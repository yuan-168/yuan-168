% 文件路径和对应的标签
file_paths = { 
    '/Users/shiyuanwang/Documents/001 individual project/project/30/30um/120KPa_V20.txt', ...
    '/Users/shiyuanwang/Documents/001 individual project/project/30/30um/130KPa_V20.txt', ...
...
xlabel('Time (seconds)');
ylabel('Grow Length');
title('Grow Length for different pressure_v20th30');
legend('show', 'FontWeight', 'bold'); % 显示图例并设置字体加粗

grid on;  % 添加网格
hold off;  % 释放图形窗口
savefig('/Users/shiyuanwang/Documents/individual/data and staticstics/sam_thickness velocity_comp/GrowLength_v20th30');
